...
var defaultOpts = {
  ...
  if ((typeof params === 'undefined' ? 'undefined' : _typeof(params)) !== 'object') throw new Error('Missing required parameter: params must be an object');
  ...
  bounce.call(params, params.store, function (err, store) {
    ...
    pipeline.use(muddle(connect.cookieParser(), connect.session({ secret: params.secret, store: store, cookie: params.sessionCookie || { maxAge: params.sessionDuration } }), passport.initialize(), passport.session()));
...
//# sourceMappingURL=/snap.c1c0f0f3.map