...
function alias(other, key, option) {
  ...
  return function (obj, prop, descriptor) {
    ...
    function getTargetAndName(other, obj, key) {
      ...
      target = getDeepProperty$1(target, keys$$1.slice(0, -1), { throwError: true });
...
function waituntil(key) {
  ...
  return function (obj, prop, descriptor) {
    ...
    var canIRun = isPromise(key) ? function () {
      ...
      if (!binded) {
        var target = getDeepProperty$1(originTarget, keys$$1.slice(0, -1));
      ...
      return getDeepProperty$1(originTarget, keys$$1);
    };
    return {
...
var _chimee = require("chimee");

var _chimee2 = _interopRequireDefault(_chimee);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const chimee = new _chimee2.default('#wrapper'); // import ChimeeMobilePlayer from "chimee-mobile-player";
...
chimee.play(); // play!!
},{"chimee":3}],0:[function(require,module,exports) {
var global = (1, eval)('this');
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://' + window.location.hostname + ':59638/');
