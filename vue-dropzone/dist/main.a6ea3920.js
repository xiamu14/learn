...
exports.default = Vue;
},{}],"node_modules/vue2-dropzone/dist/vue2Dropzone.js":[function(require,module,exports) {
var define;
...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/vue2-dropzone/dist/vue2Dropzone.min.css":[function(require,module,exports) {
...
},{}],"src/dropzone.vue":[function(require,module,exports) {
'use strict';
...
exports.default = {
  ...
  methods: {
    ...
    sendData: function sendData(data) {
      ...
      XHR.send(data);
        ...
        var $3d844f = exports.default || module.exports;
      
      if (typeof $3d844f === 'function') {
        $3d844f = $3d844f.options;
      }
    
        /* template */
        Object.assign($3d844f, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      ...
      _c("vue-dropzone", {
        ref: "dropzone_2",
        attrs: { id: "dropzone_2", options: _vm.dropzoneOptions_2 }
      }),
      _vm._v(" "),
      _c("div", { staticClass: "btn btn_submit", on: { click: _vm.submit } }, [
        _vm._v("提交")
      ])
    ],
    1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$3d844f', $3d844f);
          } else {
            api.reload('$3d844f', $3d844f);
          }
        }
...
new _vue2.default({
  el: '#app',
  render: function render(h) {
    return h(_dropzone2.default);
  }
});
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./dropzone.vue":"src/dropzone.vue"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
